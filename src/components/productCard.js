...
const ProductCard = ({ product }) => {
    ...
    return (
        ...
        >
            <img className="w-full h-auto object-cover" src={`http://localhost:8000/${product.image_path}`} alt={product.id} />
            <div className="relative h-24">
                <div className="px-2 pt-2 absolute inset-x-0 top-0">
                    <div className="font-medium text-base mb-2 "><p className='line-clamp-2'>{product.product_name}</p></div>
                </div>
